...
describe("controller", function () {
	...
	it("should show entries on start-up", function () {
		// TODO: write test
		var todoItem = { title: "my todo" };
		setUpModel([todoItem]);

		subject.setView("");

		expect(view.render).toHaveBeenCalledWith("showEntries", [todoItem]);
	});
	...
	describe("routing", function () {
		...
		it("should show active entries", function () {
			// TODO: write test
			var todoItem = { title: "my todo", completed: false };
			setUpModel([todoItem]);
		...
		it("should show completed entries", function () {
			// TODO: write test
			var todoItem = { title: "my todo", completed: true };
			setUpModel([todoItem]);
	...
	describe("toggle all", function () {
		it("should toggle all todos to completed", function () {
			// TODO: write test
			var todo = { id: 42, title: "a todo item", completed: false };
